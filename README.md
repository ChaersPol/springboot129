...
## 本项目获取地址：https://www.bishecode.com/product/126/
...
图5.1 用户管理页面【如图5.1显示的就是用户管理页面，此页面提供给管理员的功能有：对用户信息进行查询，添加，删除以及批量删除操作】
![alt text](images/image-3.png)

图5.2 景点分类管理页面【如图5.2显示的就是景点分类管理页面，管理员可以对景点分类进行添加，修改，删除，查询操作】
![alt text](images/image-4.png)

图5.3 景点信息管理页面【如图5.3显示的就是景点信息管理页面，管理员可以对景点信息信息进行添加，修改，删除，查询操作】
![alt text](images/image-5.png)

图5.4 酒店信息管理页面【如图5.4显示的就是酒店信息管理页面，管理员可以对酒店信息进行添加修改删除查询操作】
![alt text](images/image-6.png)

图5.5 景点信息页面【如图5.5显示的就是景点信息页面，用户注册登录后可以在景点信息里面点击购票。】
